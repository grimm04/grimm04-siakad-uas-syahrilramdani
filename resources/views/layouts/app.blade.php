...
<head>
  ...
  <title>Sistem Informasi Akademik Sekolah - SMK Sangkuriang 1 Cimahi</title>
...
<body class="hold-transition login-page" style="background-image: url('{{ asset("img/wallup.jpg") }}'); background-size: cover; background-attachment: fixed;">
  <div class="login-box">
    <div class="login-logo">
      <img src="{{ asset('img/logosiakad.png') }}" width="20%" alt="">
    </div>
    ...
    <footer style="color: white;"> 
      <center> 
        <strong>Copyright &copy; <script>document.write(new Date().getFullYear());</script> &diams; <a href="http://www.smksangkuriang1.sch.id/" style="color: white;">SMK Sangkuriang 1 Cimahi</a>. </strong>
      </center> 
    </footer>
  </div>
