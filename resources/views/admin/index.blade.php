            ...
            <div class="card-body">
                ...
                <div class="position-relative mb-4">
                    <div class="row">
                        ...
                        <div class="col-md-4">
                            <ul class="chart-legend clearfix">
                                <li><i class="far fa-circle" style="color: #d4c148"></i> Akuntansi dan Keuangan Lembaga</li>
                                <li><i class="far fa-circle" style="color: #ba6906"></i> Bisnis Daring dan Pemasaran</li>
                                <li><i class="far fa-circle" style="color: #ff990a"></i> Otomasi dan Tatakelola Perkantoran</li>
                                <li><i class="far fa-circle" style="color: #00a352"></i> Rekayasa Perangkat Lunak</li>
                                <li><i class="far fa-circle" style="color: #2cabe6"></i> Desain Grafika</li> 
                            </ul>
                        </div>
                    </div>
                </div>
        ...
        $(document).ready(function () {
            ...
            var pieDataPaket        = {
                labels: [
                    ...
                    'Otomasi dan Tatakelola Perkantoran',
                    'Rekayasa Perangkat Lunak',
                    'Desain Grafika'
                ],
                datasets: [
                    {
                    data: [ {{ $ak }}, {{ $bp }}, {{ $otp }}, {{ $rpl }}, {{ $dg }}],
                    backgroundColor : ['#d4c148', '#ba6906', '#ff990a', '#00a352', '#2cabe6'],
                    }
                ]
            }
            var pieOptions     = {
